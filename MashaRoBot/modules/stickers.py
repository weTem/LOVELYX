        ...
        if not is_animated:
            try:
                ...
                msg.reply_text(
                  ...
                  [
                    InlineKeyboardButton(text="Your pack is ready✨", url=f"t.me/addstickers/{packname}")
                  ],
...
def makepack_internal(
    ...
    if success:
        msg.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup([
                                [
                                    InlineKeyboardButton(text="Your pack is ready✨", url=f"t.me/addstickers/%s" % packname)
                                ],
