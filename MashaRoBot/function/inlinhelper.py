...
from MashaRoBot import BOT_USERNAME, OWNER_ID
from MashaRoBot.function.pluginhelpers import convert_seconds_to_minutes as time_convert
from MashaRoBot.function.pluginhelpers import fetch
...
async def alive_function(answers):
    ...
    msg = f"""
**[EMCEE✨](https://github.com/Aquila-14/EMCEE):**
**MainBot:** `{bot_state}`
**UserBot:** `Alive`
**Python:** `3.9`
**Pyrogram:** `{pyrover}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/Emcee_Support)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
